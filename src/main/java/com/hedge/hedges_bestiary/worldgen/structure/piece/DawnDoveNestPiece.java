...
public class DawnDoveNestPiece extends TemplateStructurePiece {
    ...
    private static final ResourceLocation NBT = ResourceLocation.fromNamespaceAndPath(HedgesBestiary.MODID, "dawn_dove_nest");

    public DawnDoveNestPiece(StructureTemplateManager manager, StructurePlaceSettings pPlaceSettings, BlockPos pos) {
        super(HBStructurePieces.DAWN_DOVE_NEST.get(), 90, manager, NBT, NBT.toString(), pPlaceSettings, pos);
    }
    ...
    private void spawnMob(ServerLevelAccessor level, BlockPos pos) {
        ...
        entity.setPos(v.x - 1, v.y + 1, v.z + 2);
