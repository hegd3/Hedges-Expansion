...
public class HBStructures {
    ...
    public static final RegistryObject<StructureType<PlomboTerritoryStructure>> PLOMBO_TERRITORY = DEF_REG.register("plombo_territory", () -> () -> PlomboTerritoryStructure.CODEC);
