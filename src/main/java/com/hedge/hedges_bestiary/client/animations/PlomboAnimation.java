...
public class PlomboAnimation {
	...
	public static final AnimationDefinition SWIPE_LEFT = AnimationDefinition.Builder.withLength(1.25F).looping()
			.addAnimation("leftarm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.375F, KeyframeAnimations.degreeVec(0.0F, -70.0F, -57.5F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.5833F, KeyframeAnimations.degreeVec(-70.0F, 25.0F, -27.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("leftarm", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.625F, KeyframeAnimations.posVec(0.0F, 0.0F, -12.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.625F, KeyframeAnimations.degreeVec(0.0F, 9.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.875F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
			))
			.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			...
			.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.6667F, KeyframeAnimations.posVec(-4.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
