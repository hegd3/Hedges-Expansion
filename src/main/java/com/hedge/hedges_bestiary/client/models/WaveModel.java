...
import com.hedge.hedges_bestiary.client.animations.WaveAnimation;
...
public class WaveModel extends HBModel<WaveEntity> {
	...
	public void setupAnim(WaveEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		this.root.xScale = pEntity.getGrowProgress();
		this.root.yScale = pEntity.getGrowProgress();
		this.root.zScale = pEntity.getGrowProgress();
