...
public class HBSounds {
    ...
    public static final RegistryObject<SoundEvent> MURK_HURT = createSoundEvent("murk_hurt");

    public static final RegistryObject<SoundEvent> MURK_STOMP = createSoundEvent("murk_stomp");
