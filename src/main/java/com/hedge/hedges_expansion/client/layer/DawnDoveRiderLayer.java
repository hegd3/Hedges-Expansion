...
import com.hedge.hedges_expansion.client.renderer.DawnDoveRenderer;
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, DawnDoveEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.isVehicle()) {
            for (Entity passenger : entity.getPassengers()) {
                ...
                HedgesExpansion.PROXY.releaseRenderingEntity(passenger.getUUID());
                poseStack.pushPose();
                ...
                poseStack.popPose();
                HedgesExpansion.PROXY.blockRenderingEntity(passenger.getUUID());
            }
