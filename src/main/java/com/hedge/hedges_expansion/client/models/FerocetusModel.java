...
public class FerocetusModel extends HierarchicalModel<FerocetusEntity> {
	...
	public void setupAnim(FerocetusEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.tailrot.yRot = Mth.lerp(0.3F, this.tailrot.yRot, tailYaw * 0.3F);
		this.tail2rot.yRot = Mth.lerp(0.3F, this.tail2rot.yRot, tailYaw * 0.25F);


		this.animate(entity.biteAnimationState, entity.swingingLeft() ? FerocetusAnimation.bite_left : FerocetusAnimation.bite_right, ageInTicks);
		this.animate(entity.ramAnimationState, FerocetusAnimation.ram, ageInTicks);
