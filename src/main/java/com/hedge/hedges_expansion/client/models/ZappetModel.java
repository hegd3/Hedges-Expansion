...
import com.hedge.hedges_expansion.client.animations.ZappetAnimation;
...
public class ZappetModel extends HEModel<ZappetEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftwing = flycontrol.addOrReplaceChild("leftwing", CubeListBuilder.create().texOffs(40, 52).addBox(0.0F, 0.0F, -3.0F, 6.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(4.5F, -2.0F, -5.0F));

		PartDefinition leftwing2 = leftwing.addOrReplaceChild("leftwing2", CubeListBuilder.create().texOffs(40, 46).addBox(0.0F, 0.0F, -3.0F, 5.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, 0.0F, 0.0F));

		PartDefinition rightwing = flycontrol.addOrReplaceChild("rightwing", CubeListBuilder.create().texOffs(40, 52).mirror().addBox(-6.0F, 0.0F, -3.0F, 6.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.5F, -2.0F, -5.0F));

		PartDefinition rightwing2 = rightwing.addOrReplaceChild("rightwing2", CubeListBuilder.create().texOffs(40, 46).mirror().addBox(-5.0F, 0.0F, -3.0F, 5.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-6.0F, 0.0F, 0.0F));
