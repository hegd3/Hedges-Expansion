...
public class SmarmModel extends HierarchicalModel<SmarmEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition swimcontrol = root.addOrReplaceChild("swimcontrol", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -1.5F, -5.0F, 3.0F, 3.0F, 9.0F, new CubeDeformation(0.0F))
				.texOffs(0, 12).addBox(0.0F, -5.5F, -5.0F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(32, 4).addBox(0.0F, 1.5F, 2.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition tail = swimcontrol.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(20, 12).addBox(0.0F, -4.5F, 0.0F, 0.0F, 6.0F, 7.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 0.0F, 4.0F));

		PartDefinition leftfin = swimcontrol.addOrReplaceChild("leftfin", CubeListBuilder.create().texOffs(26, 11).addBox(0.0F, 0.0F, -1.5F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.01F)), PartPose.offset(1.5F, 1.5F, -0.5F));

		PartDefinition rightfin = swimcontrol.addOrReplaceChild("rightfin", CubeListBuilder.create().texOffs(26, 11).mirror().addBox(0.0F, 0.0F, -1.5F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.01F)).mirror(false), PartPose.offset(-1.5F, 1.5F, -0.5F));
