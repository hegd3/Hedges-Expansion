...
import com.hedge.hedges_expansion.client.layer.ZappetGlowLayer;
...
public class ZappetRenderer extends MobRenderer<ZappetEntity, ZappetModel> {
    private static final ResourceLocation texture = new ResourceLocation(HedgesExpansion.MODID, "textures/entity/zappet/zappet.png");
