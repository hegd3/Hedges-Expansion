...
public class HEFollowOwnerGoal extends Goal {
    ...
    public HEFollowOwnerGoal(HETamableAnimal mob, double speedModifier, double sprintSpeedModifier, float startDistance, float stopDistance) {
        this(mob, speedModifier, sprintSpeedModifier, startDistance, stopDistance, false, false);
    }

    public HEFollowOwnerGoal(HETamableAnimal mob, double speedModifier, double sprintSpeedModifier, float startDistance, float stopDistance, boolean canFly, boolean shouldChangeMalus) {
        this.mob = mob;
