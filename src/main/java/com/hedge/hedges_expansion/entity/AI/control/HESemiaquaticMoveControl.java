...
public class HESemiaquaticMoveControl extends MoveControl {
    ...
    public HESemiaquaticMoveControl(Mob pMob, int pMaxTurnX, int pMaxTurnY, float pInWaterSpeedModifier) {
        super(pMob);
